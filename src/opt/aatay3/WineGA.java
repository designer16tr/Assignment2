...
public class WineGA {
    ...
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 980);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 981, 4898);
    ...
    public static void main(String[] args) {
        ...
        int[] population = {10,20,40,80,160,320};
        int[] mate = {4,8,16,32,64,128};
        int[] mute = {2,4,8,16,32,64};
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int q = 0; q < population.length; q++) {
                ...
                wotf.write_output_to_file("Optimization_Results", "WineGAtesting.csv", final_result, true);
